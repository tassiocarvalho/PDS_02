...
const int MAX_RESULTS = 2048; // Tamanho para armazenar 1023 amostras na subida e 1023 na descida
...
void timer(){
  ...
  // Cálculo: (16MHz/128 =  125KHz )/ (8 * 10230) - 1 = 0.50 aproximado para 1
  OCR1A = 1; 
  OCR1B = 1; // Mesma frequência de amostragem
}
