...
const int MAX_RESULTS = 3000; // Tamanho para armazenar 1023 amostras na subida e 1023 na descida
...
void timer(){
  ...
  // Cálculo: 125KHz / (8 * 10230) - 1 = 195 (aproximadamente)
  OCR1A = 97; 
  OCR1B = 97; // Mesma frequência de amostragem
}
